...
insert into user(`id`, `user_Id`, `password`, `name`, `email` , `created_at`) values (1,'lee','123','이강우','lee@na.com',current_timestamp());
insert into user(`id`, `user_Id`, `password`, `name`, `email`, `created_at` ) values (2,'kim','123','김민수','kim@na.com',current_timestamp());
