...
insert into user(`id`, `user_Id`, `password`, `name`, `email`,`img_code`, `created_at` ) values (2,'kim','123','김민수','kim@na.com','https://graph.facebook.com/v2.3/1324855987/picture',current_timestamp());
